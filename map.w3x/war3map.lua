...
function Trig_DemonessEnter_Func002Func010A()
    SelectUnitAddForPlayer(GetEnumUnit(), Player(0))
    PauseUnitBJ(false, GetEnumUnit())
end

function Trig_DemonessEnter_Func002Func034A()
    SelectUnitAddForPlayer(GetEnumUnit(), Player(0))
    PauseUnitBJ(true, GetEnumUnit())
    SetUnitFacingToFaceUnitTimed(GetEnumUnit(), gg_unit_ndqs_0026, 0.00)
end

function Trig_DemonessEnter_Func002Func038A()
    SelectUnitAddForPlayer(GetEnumUnit(), Player(0))
    PauseUnitBJ(false, GetEnumUnit())
    IssuePointOrderLocBJ(GetEnumUnit(), "move", GetRectCenter(gg_rct_RescuePoint))
end

function Trig_DemonessEnter_Func002Func040Func001C()
    if (not (GetDestructableTypeId(GetEnumDestructable()) == FourCC("B001"))) then
        return false
    end
    return true
...
function Trig_DemonessEnter_Func002Func040A()
    if (Trig_DemonessEnter_Func002Func040Func001C()) then
...
function Trig_DemonessEnter_Actions()
    if (Trig_DemonessEnter_Func002C()) then
        ...
        udg_sound = "Sound\\Speech\\Chapter1\\Demonesa_05"
                CreateAndMoveSpeechImage("start", 8, "left", "PeonEmotion\\DemonAngry", "Тогда сегодня на ужин у меня будет, черепаший суп!", 10,"Демонесса")
        udg_sound = "Sound\\Speech\\Chapter1\\Peonl_15"
                CreateAndMoveSpeechImage("start", 5, "right", "PeonEmotion\\foo", "Что то-то я не вижу тут черепах", 18,"Пеонльнарёфф")
        udg_sound = "Sound\\Speech\\Chapter1\\Demonesa_heh"
                CreateAndMoveSpeechImage("start", 5, "left", "PeonEmotion\\DemonBobs", "(Звуки демонической магии)", 23,"Демонесса")
        udg_sound = "Sound\\Speech\\Chapter1\\Peonetty_20"
                CreateAndMoveSpeechImage("end", 5, "right", "PeonEmotion\\foo", "О нет, она превратила Пеонльнарёфа в черепаху, бежим отсюда!", 28,"Пеонетти")
                CreateSpeechEffect(GetTriggerUnit())
        ForGroupBJ(GetUnitsInRectOfPlayer(GetPlayableMapRect(), Player(0)), Trig_DemonessEnter_Func002Func034A)
        TriggerSleepAction(28.00)
        IssueTargetOrderBJ(gg_unit_ndqs_0026, "hex", GetTriggerUnit())
                CreateSpeechEffect()
        ForGroupBJ(GetUnitsInRectOfPlayer(GetPlayableMapRect(), Player(0)), Trig_DemonessEnter_Func002Func038A)
                StartDemonessa(gg_unit_ndqs_0026)
        EnumDestructablesInRectAll(gg_rct_StonesBlock, Trig_DemonessEnter_Func002Func040A)
    else
        DisableTrigger(GetTriggeringTrigger())
        ...
        if (Trig_DemonessEnter_Func002Func003C()) then
            ...
            udg_sound = "Sound\\Speech\\Chapter1\\Demonesa_01"
                        ...
                        CreateAndMoveSpeechImage("end", 3, "left", "PeonEmotion\\DemonLeft", "Прочь!!!", 0,"Демонесса")
        else
        end
        if (Trig_DemonessEnter_Func002Func004C()) then
            ...
            udg_sound = "Sound\\Speech\\Chapter1\\Demonesa_03"
                        ...
                        CreateAndMoveSpeechImage("end", 3, "left", "PeonEmotion\\DemonLeft", "А вы ещё кто? Проваливайте!", 0,"Демонесса")
        else
        end
        if (Trig_DemonessEnter_Func002Func005C()) then
            ...
            udg_sound = "Sound\\Speech\\Chapter1\\Demonesa_04"
                        ...
                        CreateAndMoveSpeechImage("end", 3, "left", "PeonEmotion\\DemonLeft", "У меня скоро обед!", 0,"Демонесса")
        else
        end
        if (Trig_DemonessEnter_Func002Func006C()) then
            ...
            udg_sound = "Sound\\Speech\\Chapter1\\Demonesa_06"
                        ...
                        CreateAndMoveSpeechImage("end", 3, "left", "PeonEmotion\\DemonLeft", "В очередь!", 0,"Демонесса")
        else
        end
        TriggerSleepAction(2)
                TP2Point(530,-1320)
        ForGroupBJ(GetUnitsInRectOfPlayer(GetPlayableMapRect(), Player(0)), Trig_DemonessEnter_Func002Func009A)
        ForGroupBJ(GetUnitsInRectOfPlayer(GetPlayableMapRect(), Player(0)), Trig_DemonessEnter_Func002Func010A)
        TriggerSleepAction(2)
...
function Trig_FindHeal22_Actions()
    ...
    udg_sound = "Sound\\Speech\\Chapter1\\Peonetty_22"
        CreateAndMoveSpeechImage("start", 8, "left", "PeonEmotion\\normal_left", udg_TMPColorText, 0,"Пеонетти")
    udg_sound = "Sound\\Speech\\Chapter1\\Peonpio_05"
        CreateAndMoveSpeechImage("end", 5, "right", "PeonEmotion\\foo", "Ребята, а это классная штука, похожа на колу", 8,"Пеонпио")
    TriggerSleepAction(8.00)
        CreateSpeechEffect()
    PauseUnitBJ(false, GetTriggerUnit())
    TriggerSleepAction(5.00)
