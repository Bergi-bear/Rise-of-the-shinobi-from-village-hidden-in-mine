...
function Trig_Toasty_Actions()
        CreateToasty()
end

function InitTrig_Toasty()
    gg_trg_Toasty = CreateTrigger()
    TriggerRegisterPlayerEventEndCinematic(gg_trg_Toasty, Player(0))
    TriggerAddAction(gg_trg_Toasty, Trig_Toasty_Actions)
end
...
function config()
    ...
    DefineStartLocation(0, -30400.0, 0.0)
